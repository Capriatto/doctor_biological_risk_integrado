...
class doctor_atencion_riesgo_biol(osv.osv):
	...
	_columns = {
		...
		'laboratorio_inicial': fields.boolean('laboratorio inicial', states={'closed': [('readonly', True)]}),
		'laboratorio_fuente': fields.boolean('laboratorio fuente', states={'closed': [('readonly', True)]}),
		'terapia_retroviral': fields.boolean('Terapia retroviral', states={'closed': [('readonly', True)]}),
		...
		'presento_reaccion_terapia':fields.boolean('Presento reaccion terapia', states={'closed': [('readonly', True)]}),
		'presento_reaccion_terapia_cual':fields.char(u'Cuál?', states={'closed': [('readonly', True)]}),
		...
		'signos_vitales_ids': fields.one2many('doctor.signos.vitales_riesgo_biol', 'attentiont_id', 'Tabla signos vitales', ondelete='restrict', states={'closed': [('readonly', True)]}),
		...
		'diagnostico':fields.text(u'Diagnóstico ',states={'closed': [('readonly', True)]}),
